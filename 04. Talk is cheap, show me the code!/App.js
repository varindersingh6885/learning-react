...
const restaurants = [
  {
    ...
    analytics: {
      context: "seo-data-25b6f383-30f2-4b94-ad9e-cc0427075eb4",
    },
    cta: {
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2023-08-22 02:45:00",
        opened: true,
      },
      badges: {},
      isOpen: true,
  ...
  },
  {
    ...
    cta: {
      link: "https://www.swiggy.com/restaurants/kwality-walls-frozen-dessert-and-ice-cream-shop-central-hall-seshadripuram-bangalore-688449",
      text: "RESTAURANT_MENU",
      type: "WEBLINK",
    },
    widgetId: "collectionV5RestaurantListWidget_SimRestoRelevance_food_seo",
  ...
  },
  {
    info: {
      ...
      cloudinaryImageId: "ceb87b92a4f85c0ac78791e5a0608fcf",
...
const RestaurantCard = (props) => {
  ...
  return (
    <div className="restaurant-card">
      ...
      />
      <h3>{info.name}</h3>
      <h4>Cuisisnes: {info.cuisines.join(", ")}</h4>
      <h4>Rating: {info.avgRatingString}</h4>
      <h4>{info.costForTwo}</h4>
      <h4>ETA: {info.sla.slaString}</h4>
    </div>
  );
};
